...
.table-row:nth-child(even) {
    background-color: #f9f9f9; /* Change the even row background color */
}
...
.pagination {
    margin-top: 20px; /* Add margin to the pagination component */
}

.pagination__item {
    background-color: #007bff; /* Change the pagination item background color */
    color: #fff; /* Change the pagination item text color */
}

.pagination__item--active {
    background-color: #0056b3; /* Change the active pagination item background color */
}

.pagination__item:hover {
    background-color: #0056b3; /* Change the hover state background color */
}

.text-blue-600 {
    color: #007bff; /* Change the blue text color */
}

.text-yellow-400 {
    color: #ffc107; /* Change the yellow text color */
}
